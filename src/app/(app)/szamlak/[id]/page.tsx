        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6">
          <InvoiceReviewForm
            invoice={{
              ...
              netAmount: invoice.netAmount ? invoice.netAmount.toString() : null,
              vatAmount: invoice.vatAmount ? invoice.vatAmount.toString() : null,
              grossAmount: invoice.grossAmount ? invoice.grossAmount.toString() : null,
              vatRate: invoice.vatRate ? invoice.vatRate.toString() : null,
